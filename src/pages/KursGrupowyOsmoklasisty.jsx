  ...
  return (
    <div className="font-sans text-gray-900">
       <header
         ...
         >
           {/* Tytuł główny */}
           <h1 className="text-4xl lg:text-5xl font-extrabold mb-4 mt-10">Zajecia grupowe dla ósmoklasistów</h1>
           {/* Podtytuł */}
           <p className="text-lg lg:text-2xl mb-10 lg:mb-2 max-w-2xl">Pełne przygotowanie do egzaminu ósmoklasisty</p>
      ...
      >
          <h2 className="text-4xl lg:text-5xl font-bold mb-10 lg:mb-10 tracking-wide text-center lg:text-left">Świetny kurs dla ósmoklasistów!</h2>
           ...
           <div className="relative w-full max-w-md overflow-hidden">
            ...
            <div className="text-left -mt-6 lg:-mt-8 flex flex-col">
              <div className="space-y-4 text-lg lg:text-xl mt-6">
                <h2 className="text-2xl sm:text-3xl font-semibold text-center sm:text-left">Zajęciach dla ósmoklasistów online będzie dobrym wyborem jeśli:</h2>
                <p className="text-base lg:text-lg">
                  •	Twoje dziecko przygotowuje się do egzaminu ósmoklasisty z języka angielskiego i chcecie mieć pewność, że nie zabraknie mu żadnej umiejętności ani materiału,<br/>
                  •	zależy Wam na kompleksowym przygotowaniu – pisaniu, słuchaniu, czytaniu, słownictwie i gramatyce – a nie tylko wybranych fragmentach egzaminu,<br/>
                  •	szukacie kursu w małej grupie (max 6 osób), gdzie nauczyciel ma czas sprawdzić prace pisemne każdego ucznia i realnie pracować nad jego błędami,<br/>
                  •	chcecie, aby dziecko uczyło się w gronie rówieśników na podobnym poziomie – to dodaje motywacji i zdrowej rywalizacji, a nie stresuje jak w dużej klasie,<br/>
                  •	zależy Wam na przećwiczeniu wszystkich typów zadań egzaminacyjnych, tak żeby dziecko dobrze znało formułę egzaminu i nie dał się zaskoczyć na sali,<br/>
                  •	szukacie kursu, który obejmuje cały materiał wymagany na egzaminie – od podstaw gramatycznych po zaawansowane słownictwo tematyczne,<br/>
                  •	chcecie, żeby dziecko zyskało pewność siebie przed egzaminem, regularnie pisząc próbne zadania i otrzymując informację zwrotną,<br/>
                  •	zależy Wam na terminowym przygotowaniu, tak aby przed egzaminem powtórzyć i utrwalić cały materiał, a nie uczyć się w pośpiechu na ostatnią chwilę.
                </p>
              </div>
            </div>
          </div>
       ...
       >
              ...
              <div className="flex flex-col items-center justify-center max-w-4xl mx-auto gap-6">
                <div className="bg-white border-3 border-black rounded-2xl shadow-2xl p-8 flex flex-col items-center justify-center text-center w-full transform hover:scale-105 hover:-translate-y-2 transition-transform">
                  ...
                  <h3 className="text-lg font-medium leading-snug text-black">
                    Kurs trwa 27 tygodni i obejmuje systematyczne przygotowanie z języka angielskiego na poziomie wymaganym na egzaminie ósmoklasisty. Spotykamy się dwa razy w tygodniu na 60-minutową lekcję.
                  </h3>
                </div>
                ...
                <div className="bg-white border-3 border-black rounded-2xl shadow-2xl p-8 flex flex-col items-center justify-center text-center w-full transform hover:scale-105 hover:-translate-y-2 transition-transform">
                  ...
                  <h3 className="text-lg font-medium leading-snug text-black">
                    Koszt kursu to 2160 zł - czyli 40 zł za jedne zajęcia. Koszt możesz opłacić w całości lub rozłożyć na raty - wybór należy do Ciebie.
                  </h3>
                </div>

                <div className="bg-white border-3 border-black rounded-2xl shadow-2xl p-8 flex flex-col items-center justify-center text-center w-full transform hover:scale-105 hover:-translate-y-2 transition-transform">
                   <h3 className="text-2xl font-bold leading-snug text-black mb-2">
                     Jaki poziom języka angielskiego jest wymagany na start?
                   </h3>
                   <h3 className="text-lg font-medium leading-snug text-black">
                    Kurs jest dostosowany do uczniów na różnym poziomie — materiał budujemy stopniowo, więc nie trzeba mieć zaawansowanej znajomości języka, by zacząć.
                   </h3>
                </div>
                ...
                <div className="bg-white border-3 border-black rounded-2xl shadow-2xl p-8 flex flex-col items-center justify-center text-center w-full transform hover:scale-105 hover:-translate-y-2 transition-transform">
                    ...
                    <h3 className="text-lg font-medium leading-snug text-black">
                      Kurs obejmuje wszystkie umiejętności sprawdzane na egzaminie: rozumienie ze słuchu, rozumienie tekstów pisanych, znajomość funkcji językowych,
                      znajomość środków językowych (gramatyka i słownictwo) oraz pisanie krótkich tekstów użytkowych.
                    </h3>
                </div>

                <div className="bg-white border-3 border-black rounded-2xl shadow-2xl p-8 flex flex-col items-center justify-center text-center w-full transform hover:scale-105 hover:-translate-y-2 transition-transform">
                     <h3 className="text-2xl font-bold leading-snug text-black mb-2">
                       Co się stanie, jeśli uczeń opuści zajęcia?
                     </h3>
                     <h3 className="text-lg font-medium leading-snug text-black">
                      Każda lekcja jest nagrywana, dzięki czemu uczeń może nadrobić zaległości w dogodnym dla siebie czasie.
                     </h3>
                </div>

                <div className="bg-white border-3 border-black rounded-2xl shadow-2xl p-8 flex flex-col items-center justify-center text-center w-full transform hover:scale-105 hover:-translate-y-2 transition-transform">
                   <h3 className="text-2xl font-bold leading-snug text-black mb-2">
                    Czy nauczyciele mają doświadczenie w przygotowywaniu do egzaminu ósmoklasisty?
                   </h3>
                   <h3 className="text-lg font-medium leading-snug text-black">
                    Tak, zajęcia prowadzą nauczyciele języka angielskiego z doświadczeniem w pracy z uczniami klas 7–8 oraz znajomością aktualnych wymagań egzaminacyjnych CKE.
                   </h3>
                </div>
             </div>
       </section>
...
export default KursGrupowyOsmoklasisty;
